package com.eso.mvvmprojectexample.room.database;
...
public abstract class BooksDatabase extends RoomDatabase {
    ...
    private static RoomDatabase.Callback callback = new Callback() {
        ...
        public void onCreate(@NonNull SupportSQLiteDatabase db) {
            new InitialDataAsyncTasd(instance).execute();
            super.onCreate(db);

        }
    };

    private static class InitialDataAsyncTasd extends AsyncTask<Void,Void,Void>{

        private CategoryDAO categoryDAO;
        private BookDAO bookDAO;

        public InitialDataAsyncTasd(BooksDatabase booksDatabase) {
